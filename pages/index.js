            ...
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className={styles["imagecontainer"]}>
                  <img className={styles["horizontal"]} src="/img/personal.png" alt="Personal website homepage" /><Link href="/blog/personal"><div className={styles["centered"]}>
              ...
              <div className="swiper-slide">
                <div className={styles["imagecontainer"]}>
                  <img className={styles["horizontal"]} src="/img/info340.png" alt="Personal website homepage" /><Link href="/blog/info340"><div className={styles["centered"]}>
                    <h1 className="carousel-class">TravelMuse</h1>
                    <p className={styles["carousel-text"]}>Read about how I created an itinerary planner using React, HTML/CSS and JavaScript!</p></div></Link>
                </div>
              </div>
              <div className="swiper-slide">
                <div className={styles["imagecontainer"]}>
