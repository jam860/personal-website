                ...
                <div className={styles["content"]}>
                    ...
                    <div className={styles["article-content"]}>
                        ...
                        <section>
                            ...
                            <p>Since I was still relatively new to HTML/CSS, JavaScript and React, I knew that I didn't want to make a super complex website, but I thought of ways to make it a somewhat challlening project. I used a React framework called next.js which is super helpful with routing websites and have server-side rendering to make everything super fast. I added a form to my website so that others can easily message me and get a response by email. In terms of styling, I wanted a palette that was welcoming and easy on the eyes. Yellow has always been one of my favorite colors, so I decided to surround my palette around a golden yellow color.</p>
                        </section>

                        <section>
                            <h2>The Process</h2>
                            <p>Starting with the navigation bar, I wanted to keep it super simple. I had my logo which redirects to the homepage, along with two other links that point the user to either the blog page or the contact me page. For the start of my homepage, I had a picture of myself and a little introduction. Below that, I had a couple of images that others could click on to get in contact with me. Below the introduction, I had another section that has a carousel with featured blogs. I used a new library called Swiper.js, which I hadn't used before, but it was interesting to see how it worked. Lastly, for all pages, I wanted to add a footer with ways to contact me. I once again included a couple of images that users could use to get in touch with me, and a form that people can use to easily message me. In order to make these sections, I heavily relied on using flexboxes in order to align everything correctly. </p>
                            <p>As for the contact me page, it was similar to the footer. I had a messaging form while also having two images that allowed people to contact me. With the power of React, it was really easy to reuse some of the components from the footer into the contact me page. Getting the form to function was probably the hardest part of making this website, since I wanted to include validation. I used a React hook called "React Hook Form" that I used to register and track input values while also using Zod for validation. I didn't completely use the React Hook Form library since validations for emails were easier to validate using Zod. I also restyled the form so that the messaging form was more distinct from the footer itself.</p>
                            <p>The blog page consists of written articles that I've made about my classes, projects, and some of the non-academic things. I also made a lot of components using React such as “article cards” and the actual “article preview” which lists of those article cards. Each card basically led to a blog about the topic that I was writing about. Each article card contains the title, a small description of the article and a small image on the right. I used a flexbox to center everything so that it was easy to look through the articles.</p>
